...
const configGame = {
  ...
  value: '',
  currentValue: 0,
  timer: typeGame == 'real' ? 60 : 60,
  meta: () => { return typeGame == 'real' ? configGame.value * 20 : configGame.value * 20; }
}
...
function extTriggerPoints(coin = 2) {
  var currentPoints = els.currentPoints();
  var percent = typeGame == 'real'? 20 : 20;
...
function execGreen() {
    ...
    form.setAttribute('action', '/gameover/win.php');
...
function execRed() {
    ...
    var form = document.createElement('form');
    form.setAttribute('method', 'post');
    form.setAttribute('action', '/gameover/loss.php');
