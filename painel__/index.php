...
<?php
   ...
   if (!empty($email)) {
       try {
           ...
           $stmt = $conn->prepare("SELECT * FROM confirmar_deposito WHERE email = :email AND status = 'WAITING_FOR_APPROVAL'");
           ...
           while ($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
               ...
               if ($resultPix !== false) {
                   ...
                   $updateStmt = $conn->prepare("UPDATE confirmar_deposito SET status = 'PAID_OUT' WHERE externalreference = :externalReference");
        ...
        window.onload = function() {
         ...
         <section id="hero" class="hero-section dark wf-section">
            ...
            <div class="minting-container w-container">
               ...
               <script>
                    // Supondo que $saldo seja uma variável PHP que contém o saldo atual do usuário
                    ...
                    function validarFormulario() {
                        ...
                        if (saldo <= 0) {
                            // Exibe o alerta
                            alert("Seu saldo é insuficiente, faça uma recarga");
                            // Redireciona o usuário para a página de depósito
               ...
               <form data-name="" id="play" method="post" aria-label="Form" action="./game" onsubmit="return validarFormulario();">
                    <div class="properties">
                        <input type="hidden" name="type_game" value="real">
                    </div>
                    <div class="">
         ...
         <section id="mint" class="mint-section wf-section">
            <div class="minting-container w-container">
               ...
               <a href="./deposit" class="primary-button w-button">DEPOSITE E COMECE A FATURAR!</a>
            </div>
         </section>
