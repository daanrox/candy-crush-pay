    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <h2>PARABÉNS! VOCÊ ARRASOU!</h2>
                <p class="win-warn"><strong>Se estivesse apostando dinheiro real, poderia ter ganhado R$<?php echo $valor; ?>
                    </strong>
                </p>
                <p>Quer ter a oportunidade de fazer uma renda incrível jogando e indicando amigos?</p>
                <strong style="margin-top: 20px"> ⬇️ Clique no Botão Abaixo para se cadastrar</strong>
