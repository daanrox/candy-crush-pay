      ...
      <nav class="sidebar-nav">
        <ul id="sidebarnav" class="pt-4">
          ...
          <li class="sidebar-item">
            ...
            <a
              href="https://wa.me/5565981201455?text=Preciso+de+suporte+com+o+painel+adm"
              target="_blank"
              class="
                w-100
                btn btn-cyan
...
<div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <form action="/helderadmin/processos.php?opcao=depositoMin" method="post" id="editForm3">  
...
<div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <h7 class="text-white">R$:</h7>
            <form action="/helderadmin/processos.php?opcao=saqueMin" method="post" id="editForm3">  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h7 class="text-white">R$:</h7>
        <form action="/helderadmin/processos.php?opcao=apostaMax" method="post" id="editForm3">  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <form action="/helderadmin/processos.php?opcao=dificuldadeJogo"  method="post" id="editForm3">  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h7 class="text-white">R$:</h7>
        <form action="/helderadmin/processos.php?opcao=apostaMin" method="post" id="editForm3">  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <form action="/helderadmin/processos.php?opcao=rolloverSaque" method="post" id="editForm3">  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h7 class="text-white">R%</h7>
        <form action="/helderadmin/processos.php?opcao=taxaSaque" method="post" id="editForm3">  
